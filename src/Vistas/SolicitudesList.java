 ...
 * @author ignac
 */
public class SolicitudesList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo Seguimiento", "Nombre Cliente", "Nombre Especialista", "Tipo Solicitud", "Precio"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SolicitudesList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SolicitudesList().setVisible(true);
            }
        });
    }
